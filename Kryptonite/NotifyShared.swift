...
class NotifyShared {
    ...
    static func appDataProtectionNotAvailableError() -> UNNotificationContent {
        let content = appErrorNotificationContent(title: "Kryptonite Locked",
                                                               error: "Kryptonite cannot be used before the device has been unlocked for the first time. Please unlock your device and try again.")
        return content
    }
